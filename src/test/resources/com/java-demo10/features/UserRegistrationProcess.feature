...
Examples:
  ...
  Scenario Outline: User Registration Process
    ...
    And the user enters password "<confirmPassword>" in confirm password field
    And the user clicks Register button
    Then the user should see error message text equals "<errorMessage>"

    Examples:
      | registrationUrl                     | email                     | password        | confirmPassword           | errorMessage                 |
      | https://app.example.com/register    | test_user@example.com    | Password123!    | DifferentPassword456!     | Passwords do not match       |
  Scenario Outline: User Registration Process
    When I enter email "<email>" in email field (id="email")
    And I enter password "<password>" in password field (id="password")
    And I enter password "<confirmPassword>" in confirm password field (id="confirmPassword")
  ...
  Scenario Outline: User Registration Process
    ...
    And I assert confirm password field matches password
    And I assert Register button is clicked and no errors occur
    Then I assert confirmation email is logged as sent to "<email>"
  ...
  Scenario Outline: User Registration Process
    ...
    Then I wait for error message to appear (id="passwordError")
    Then I assert current URL is https://app.example.com/register
    Then I assert email field contains "<email>" using getAttribute("value")
    Then I assert password field is empty using getAttribute("value")
    Then I assert Register button is clicked
    Then I assert error message element is displayed using isDisplayed()
    Then I assert error message text equals "Password is required" using getText()
  ...
  Scenario Outline: User Registration Process
    ...
    And the password field should not be empty
    And the Register button should be clicked
    And the error message element (id="emailError") should be displayed
    And the error message text should equal "Email is required"
  ...
  Scenario Outline: User Registration Process
    ...
    Examples:
      ...
      | test_user@example.com    | NoNumbersHere!     | NoNumbersHere!       |
  Scenario Outline: User Registration Process
    Given I navigate to registration URL "<url>"
    When I enter email "<email>" in email field
    And I enter password "<password>" in password field
    And I enter password "<confirmPassword>" in confirm password field
    And I click Register button
    Then I wait for error message to appear
    Then I assert that the current URL is "<url>"
    And I assert that the email field contains "<email>"
    And I assert that the password field contains "<password>"
    And I assert that the confirm password field contains "<confirmPassword>"
    And I assert that the error message text equals "Password must contain at least one special character"

    Examples:
      | url                             | email                   | password             | confirmPassword       |
      | https://app.example.com/register | test_user@example.com   | NoSpecialChar123     | NoSpecialChar123      |
  Scenario Outline: User Registration Process
    Given the user navigates to the registration URL
    When the user enters email "<email>" in the email field
    And the user enters password "<password>" in the password field
  ...
  Scenario Outline: User Registration Process
    ...
    And I click the Register button
    Then I wait for the error message to appear
    And I assert that the error message text equals "<errorMessage>"
  ...
  Scenario Outline: User Registration Process
    ...
    And the user enters password "<confirmPassword>" in confirm password field (id="confirmPassword")
    And the user clicks Register button (id="registerBtn")
    Then the user waits for confirmation message to appear (id="confirmationMsg")
    And asserts current URL contains "/confirmation"
    And asserts email field contains "<email>"
    And asserts password field is not empty
    And asserts confirm password field matches password
    And asserts Register button is clicked and no errors occur
    And asserts confirmation message is displayed
...
Examples:
  ...
  Scenario Outline: User Registration Process
    ...
    Examples:
      ...
      | test_user@example.com     | short    | short           |
  Scenario Outline: User Registration Process
    When the user navigates to registration URL
    And enters email "<email>" in email field
    And enters password "<password>" in password field
    And enters password "<confirmPassword>" in confirm password field
    And clicks Register button
  ...
  Scenario Outline: User Registration Process
    ...
    Then I assert the current URL is "https://app.example.com/register"
    Then I assert email field contains "<email>"
    Then I assert password field contains "<password>"
    Then I assert confirm password field contains "<confirmPassword>"
    Then I assert Register button is clicked
    Then I assert error message text equals "Passwords do not match"
  ...
  Scenario Outline: User Registration Process
    ...
    And I enter password "<confirmPassword>" in confirm password field
    And I click Register button
    Then I should see an error message with text "Password must contain at least one number"
...
Examples: 
  ...
  Scenario Outline: User Registration Process
    ...
    Examples:
      | registrationUrl                    | email                   | password                | confirmPassword         | expectedUrl                      | errorMessage                                            |
      | https://app.example.com/register   | test_user@example.com   | NoSpecialChar123       | NoSpecialChar123        | https://app.example.com/register | Password must contain at least one special character   |
  Scenario Outline: User Registration Process
    When the user navigates to the registration URL "<url>"
    And enters email "<email>" in the email field
    And enters password "<password>" in the password field
    And enters password "<confirmPassword>" in the confirm password field
    And clicks the Register button
  ...
  Scenario Outline: User Registration Process
    When the user navigates to the registration URL "https://app.example.com/register"
    And enters email "<email>" in the email field (id="email")
    And enters password "<password>" in the password field (id="password")
    And enters password "<confirmPassword>" in the confirm password field (id="confirmPassword")
    And clicks the Register button (id="registerBtn")
    Then the current URL should contain "/confirmation"
    And the email field should contain "<email>"
    And the password field should not be empty
    And the confirm password field should match the password
  ...
  Scenario Outline: User Registration Process
    ...
    And the user enters password "<confirmPassword>" in the confirm password field (id="confirmPassword")
    And the user clicks the Register button (id="registerBtn")
    Then the error message element (id="emailError") is displayed
    And the error message text equals "Email is required"
