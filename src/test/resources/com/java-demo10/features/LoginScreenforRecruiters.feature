...
Scenario Outline: Login Screen for Recruiters
  ...
  Then the system processes the login request
  And the user is logged out successfully
  When the user navigates back to the Login Screen
  Then the Email ID field is pre-filled with "<email_id>"
...
Scenario Outline: Login Screen for Recruiters
  ...
  Then the system processes the login request
  And recruiter-specific features are visible and accessible
  And the user clicks on the candidate search feature
  Then the candidate search functionality works as expected
...
@toggle_password_visibility
Scenario Outline: Login Screen for Recruiters
  Given the user enters a valid password "<password>"
  When the user clicks the 'Show Password' option
  Then the password should be visible
  When the user clicks the 'Hide Password' option
  Then the password should not be visible
  And the user enters a new password "<new_password>"
  When the user clicks the 'Show Password' option again
  Then the new password should be visible
...
Scenario Outline: Login Screen for Recruiters
  ...
  And I click the Login button
  Then the system processes the login request
  And the dashboard features are visible and accessible
...
Scenario Outline: Login Screen for Recruiters
  ...
  And the notifications should be relevant and up-to-date
...
Scenario Outline: Login Screen for Recruiters
  ...
  Then the Login button should be enabled
  When I click the Login button
  Then the page should respond after clicking the Login button
  And I verify the URL of the redirected page
  And I check for the presence of the dashboard elements
...
Scenario Outline: Login Screen for Recruiters
  ...
  And I click the Login button
  Then the page response should be observed
  And the dashboard features should be visible
  And I click on a job posting
  Then the job posting details should be displayed correctly
...
Scenario Outline: Login Screen for Recruiters
  ...
  When I click the 'Hide Password' option
  Then the password should not be visible
  When I enter "<password2>" in the Password field
  And I click the 'Show Password' option
  Then the new password should be visible
...
Scenario Outline: Login Screen for Recruiters
  ...
  And I enter "<reset_email_id>" for password reset
  Then the password reset request is submitted successfully
...
Scenario Outline: Login Screen for Recruiters
  ...
  And the user remains active on the dashboard for an extended period
  And the user performs various actions on the dashboard
  Then the user is still logged in after the period
...
Scenario Outline: Login Screen for Recruiters
  ...
  And I click the Login button
  Then I should see the page response
  When I click on the preferences option on the dashboard
  Then I should see the preferences page
  And the preferences options should be relevant and accessible
...
Scenario Outline: Login Screen for Recruiters
  ...
  And I enter "<password>" in the Password field
  And the user clicks the Login button
  Then the user observes the page response
  And the dashboard features are visible
  And the user clicks on a job posting to view details
  Then the job posting details are displayed correctly
...
Scenario Outline: Login Screen for Recruiters
  ...
  Then the system processes the login request
  And I click on the roles option on the dashboard
  Then the roles page should be displayed correctly
  And the roles options should be relevant and accessible

  Examples:
    | email_id              | password            |
    | recruiter@example.com  | SecurePassword123   |
@validate_login_session_timeout
Scenario Outline: Login Screen for Recruiters
  When I enter "<email>"
  And I enter "<password>"
  And I click the Login button
...
Scenario Outline: Login Screen for Recruiters
  ...
  Then the system processes the login request
  And I click on the preferences option on the dashboard
  Then the preferences page should be displayed correctly
  And the preferences options should be relevant and accessible
...
Scenario Outline: Login Screen for Recruiters
  ...
  And I click the Login button
  Then the system processes the login request
  When I click on the activity log option on the dashboard
  Then the activity log page is displayed
  And the activity log entries are relevant and accurate
...
Scenario Outline: Login Screen for Recruiters
  ...
  Scenario Outline: Login Screen for Recruiters 
    ...
    Examples: 
      ...
      | recruiter@example.com    | SecurePassword123    |
  Scenario Outline: Login Screen for Recruiters
    When I enter a valid email ID "<emailID>" in the Email ID field
    And I enter a valid password "<password>" in the Password field
    And I click the Login button
    Then I observe the page response after clicking the Login button
    And I verify the presence of recruiter-specific features
    And I click on the candidate search feature
    Then I verify the candidate search functionality works as expected
  ...
  Scenario Outline: Login Screen for Recruiters
    ...
    And I click the Login button
    Then I should see the page response
    And I should verify the URL of the redirected page
    And I should check for the presence of the dashboard elements

    Examples:
      | email             | password            |
      | krishna@gmail.com | SecurePassword123   |
  Scenario Outline: Login Screen for Recruiters
    When I enter a valid email ID "<email ID>" in the Email ID field
    And I enter a valid password "<password>" in the Password field
    And I check the 'Remember Me' option
    And I click the Login button
    Then I observe the page response after clicking the Login button
    And I log out of the application
    And I navigate back to the login screen
    Then the Email ID field is pre-filled with the valid email ID "<email ID>"

    Examples:
      | email ID                | password            |
      | recruiter@example.com   | SecurePassword123   |
  Scenario Outline: Login Screen for Recruiters
    When the user enters a valid email ID "<email>" in the Email ID field
    ...
    Examples:
      | email              | password          |
      | krishna@gmail.com  | ValidPassword123  |
  Scenario Outline: Login Screen for Recruiters #UniqueTag: @LoginScenario
    ...
    Examples:
      ...
      | krishna@gmail.com   | validPassword123   |
  Scenario Outline: Login Screen for Recruiters
    When the recruiter enters a valid email ID "<email>" in the Email ID field
    And enters a valid password "<password>" in the Password field
    And clicks the Login button
    Then the system processes the login request
    And remains active on the dashboard for an extended period
    And performs various actions on the dashboard
    Then the user is still logged in and the dashboard elements are accessible
    ...
    Examples:
      ...
      | krishna@gmail.com | ValidPassword123  |
  Scenario Outline: Login Screen for Recruiters
    When the recruiter enters <email_id> in the Email ID field
    And the recruiter enters <password> in the Password field
    And the recruiter clicks the Login button
    Then the system processes the login request
    And all dashboard features are visible and accessible
    And the recruiter clicks on a job posting to view details
    Then the job posting details are displayed correctly
    ...
    Examples:
      ...
      | recruiter@example.com   | SecurePassword123   |
  Scenario Outline: Login Screen for Recruiters
    When the recruiter enters a valid email ID "<emailID>" in the Email ID field
    And the recruiter enters a valid password "<password>" in the Password field
    And the recruiter clicks the Login button
    Then the system processes the login request
    When the recruiter clicks on the 'Forgot Password?' link
    And the recruiter enters the email ID "<resetEmailID>" for password reset
    Then the password reset request is submitted successfully

    Examples:
      | emailID               | password            | resetEmailID           |
      | recruiter@example.com  | ValidPassword123    | recruiter@example.com   |
  Scenario Outline: Login Screen for Recruiters
    ...
    Then the password is not visible
    When I enter a new password "<new_password>" in the Password field
    And I click the 'Show Password' option again
    Then the new password is visible
  ...
  Scenario Outline: Login Screen for Recruiters
    ...
    And the user clicks the Login button
    Then the system processes the login request
    And the user clicks on the help icon on the dashboard
    Then the help resources page is displayed correctly
    And the help resources are relevant and accessible
  ...
  Scenario Outline: Login Screen for Recruiters
    ...
    And the user clicks the Login button
    Then the system processes the login request
    And the user clicks on the notifications icon on the dashboard
    Then the notifications panel is displayed correctly
    And the notifications are relevant and up-to-date
  ...
  Scenario Outline: Login Screen for Recruiters
    ...
    Examples:
      | email                   | password             |
      | recruiter@example.com   | SecurePassword123    |
  Scenario Outline: Login Screen for Recruiters #Tag456
    When I enter a valid email ID "<emailID>" in the Email ID field
    And I enter a valid password "<password>" in the Password field
    And I click the Login button
    Then I observe the page response after clicking the Login button
    And I click on the roles option on the dashboard
    Then I verify the roles page is displayed
    And I check that the roles options are relevant and accessible
  ...
  @LoginScreenTest
  Scenario Outline: Login Screen for Recruiters
    When the recruiter enters "<email>" in the Email ID field
    And the recruiter enters "<password>" in the Password field
    And the recruiter clicks the Login button
    Then the system processes the login request
    And the recruiter clicks on the feedback option on the dashboard
  ...
  Scenario Outline: Login Screen for Recruiters
    ...
    And the recruiter clicks the Login button
    Then the system processes the login request
    And the recruiter clicks on the profile settings option on the dashboard
    Then the profile settings page is displayed correctly
    And the user's information is displayed accurately
    ...
    Examples:
      ...
      | krishna@gmail.com    | ValidPassword123   |
  Scenario Outline: Login Screen for Recruiters
    When the user enters a valid email ID "<emailID>" in the Email ID field
    And the user enters a valid password "<password>" in the Password field
    And the user clicks the Login button
    Then the system processes the login request
    And the user clicks on the preferences option on the dashboard
  ...
  Scenario Outline: Login Screen for Recruiters
    ...
    Then I observe the page response after clicking the Login button
    And I click on the permissions option on the dashboard
    Then I verify the permissions page is displayed
    And I check that the permissions options are relevant and accessible
  ...
  Scenario Outline: Login Screen for Recruiters
    ...
    Examples:
      | email                   | password             |
      | recruiter@example.com   | SecurePassword123    |
  Scenario Outline: Login Screen for Recruiters #UniqueTag67890
    When the user enters a valid email ID "<email>" in the Email ID field
    And enters a valid password "<password>" in the Password field
    And clicks the Login button
    Then observe the page response after clicking the Login button
    And clicks on the settings option on the dashboard
    Then verify the settings page is displayed
    And check that the settings options are relevant and accessible
  ...
  Scenario Outline: Login Screen for Recruiters
    ...
    And clicks the Login button
    Then the system processes the login request
    And the settings option is accessible
    When the recruiter clicks on the settings option on the dashboard
    Then the settings page is displayed correctly
    And the settings options are relevant and accessible
  ...
  Scenario Outline: Login Screen for Recruiters
    ...
    And the recruiter clicks the Login button
    Then the system processes the login request
    And the recruiter clicks on the profile option on the dashboard
    Then the profile page is displayed correctly
    And the profile information is displayed accurately
  ...
  Scenario Outline: Login Screen for Recruiters
    ...
    Examples:
      | email                   | password            |
      | recruite  Scenario Outline: Login Screen for Recruiters #Tag456
    When I enter a valid email ID "<emailID>" in the Email ID field
    And I enter a valid password "<password>" in the Password field
    And I click the Login button
    Then I observe the page response after clicking the Login button
...
ePassword123   |
  ...
  Scenario Outline: Login Screen for Recruiters
    ...
    Examples:
      ...
      | krishna@gmail.com    | ValidPassword123   |
  Scenario Outline: Login Screen for Recruiters
    When the user enters a valid password "<password>" in the Password field
    And the user clicks the 'Show Password' option
    Then the password is visible
    And the user clicks the 'Hide Password' option
    Then the password is not visible
    When the user enters a new password "<newPassword>" in the Password field
    And the user clicks the 'Show Password' option again
    Then the new password is visible
  ...
  Scenario Outline: Login Screen for Recruiters
    ...
    And the user logs out of the application
    And the user navigates back to the login screen
    Then the Email ID field should be pre-filled with the valid email ID
  ...
  Scenario Outline: Login Screen for Recruiters
    ...
    And the recruiter clicks the Login button
    Then the system processes the login request
    When the recruiter navigates to a different page within the application
    And the recruiter returns to the dashboard
    Then the dashboard elements are visible and the user is still logged in
  ...
  Scenario Outline: Login Screen for Recruiters
    When I enter a valid email ID "<email>" in the Email ID field
    And I enter a valid password "<password>" in the Password field
    Then I observe the state of the Login button
    And I click the Login button
    Then I observe the page response after clicking the Login button
    And I verify the URL of the redirected page
    Then I check for the presence of the dashboard elements

    Examples:
      | email                | password           |
      | krishna@gmail.com    | ValidPassword123   |
  Scenario Outline: Login Screen for Recruiters #UniqueTag: @ScenarioLogin

    When the recruiter enters a valid email ID "<email>" in the Email ID field
    And the recruiter enters a valid password "<password>" in the Password field
    And the recruiter clicks the Login button
    Then the system processes the login request
    And the user remains active on the dashboard for an extended period (e.g., 30 minutes)
    And the user performs various actions on the dashboard
    Then the user is still logged in and the dashboard elements are accessible
  ...
  Scenario Outline: Login Screen for Recruiters
    ...
    And I enter a valid password "<password>" in the Password field
    And I click the Login button
    Then I should see the system processing the login request
    And I should see all dashboard features visible and accessible
    And I click on a job posting to view details
    Then I should see the job posting details displayed correctly
  ...
  Scenario Outline: Login Screen for Recruiters
    ...
    And I click the Login button
    Then the page response is processed
    And recruiter-specific features are visible
    And I click on the candidate search feature
    Then the candidate search functionality works as expected
  ...
  Scenario Outline: Login Screen for Recruiters
    ...
    Then the system processes the login request
    And the user clicks on the 'Forgot Password?' link
    When the user enters the email ID "<emailID>" for password reset
    Then the password reset request is submitted successfully
  ...
  Scenario Outline: Login Screen for Recruiters
    ...
    Examples:
      ...
      | krishna@gmail.com    | validPassword123   |
  Scenario Outline: Login Screen for Recruiters
    When the recruiter enters a valid email ID "<email>"
    And the recruiter enters a valid password "<password>"
    And the recruiter clicks the Login button
    Then the system processes the login request
    And the recruiter clicks on the profile settings option on the dashboard
    Then the profile settings page is displayed correctly
  ...
  Scenario Outline: Login Screen for Recruiters
    ...
    And clicks the Login button
    Then the system processes the login request
    And clicks on the help icon on the dashboard
    Then the help resources page is displayed correctly
    And verifies the help resources are relevant and accessible
  ...
  Scenario Outline: Login Screen for Recruiters
    ...
    And the recruiter clicks the Login button
    Then the system processes the login request
    And the recruiter clicks on the settings icon on the dashboard
    Then the settings page is displayed correctly
    And the settings options are relevant and accessible
  ...
  Scenario Outline: Login Screen for Recruiters
    ...
    And the recruiter clicks the Login button
    Then the system processes the login request
    And the recruiter clicks on the notifications icon on the dashboard
    Then the notifications panel is displayed correctly
    And the notifications are relevant and up-to-date
  ...
  Scenario Outline: Login Screen for Recruiters
    ...
    And the recruiter clicks the Login button
    Then the system processes the login request
    And the recruiter clicks on the preferences option on the dashboard
    Then the preferences page is displayed correctly
    And the preferences options are relevant and accessible
  ...
  Scenario Outline: Login Screen for Recruiters
    ...
    And the recruiter clicks the Login button
    Then the system processes the login request
    And the recruiter clicks on the activity log option on the dashboard
    Then the activity log page is displayed correctly
    And the activity log entries are relevant and accurate
  ...
  Scenario Outline: Login Screen for Recruiters
    ...
    Examples: 
      ...
      | krishna@gmail.com   | ValidPassword123    |
  Scenario Outline: Login Screen for Recruiters
    When I enter a valid email ID in the Email ID field "<email>"
    And I enter a valid password in the Password field "<password>"
    And I click the Login button
    Then I observe the page response after clicking the Login button
    And I click on the notifications option on the dashboard
    Then I verify the notifications page is displayed
    And I check that the notifications options are relevant and accessible
...
Scenario Outline: Login Screen for Recruiters
  ...
  Examples:
    | email                | password           |
    | krishna@gmail.com    | ValidPassword123   |
  Scenario Outline: Login Screen for Recruiters #Tag2
    When I enter "<email>" in the Email ID field
    And I enter "<password>" in the Password field
    And I click the Login button
    Then the system processes the login request
...
ePassword123     |
  ...
  Scenario Outline: Login Screen for Recruiters
    ...
    And the recruiter clicks the Login button
    Then the system processes the login request
    And the recruiter navigates to a different page within the application
    And the recruiter returns to the dashboard
    Then the dashboard elements are visible and the recruiter is still logged in
  ...
  Scenario Outline: Login Screen for Recruiters
    ...
    And the user logs out of the application
    And the user navigates back to the login screen
    Then the Email ID field is pre-filled with the valid email ID
  ...
  Scenario Outline: Login Screen for Recruiters
    ...
    And the user clicks the 'Hide Password' option
    Then the password is not visible
    And the user enters a new password "<new_password>" in the Password field
    And the user clicks the 'Show Password' option again
    Then the new password is visible
  ...
  Scenario Outline: Login Screen for Recruiters
    ...
    And clicks the Login button
    Then the system processes the login request
    And the recruiter clicks on the 'Forgot Password?' link
    When the recruiter enters the email ID "<emailIDReset>" for password reset
    And submits the password reset request
    Then the password reset request is submitted successfully

    Examples:
      | emailID                   | password           | emailIDReset             |
      | recruiter@example.com     | ValidPassword123   | recruiter@example.com     |
  Scenario Outline: Login Screen for Recruiters #Tag456
    When the recruiter enters "<email>" in the Email ID field
    And the recruiter enters "<password>" in the Password field
  ...
  Scenario Outline: Login Screen for Recruiters
    ...
    And I click the Login button
    Then I observe the page response after clicking the Login button
    When I click on the help icon on the dashboard
    Then I verify the help resources page is displayed
    And I check that the help resources are relevant and accessible
  ...
  Scenario Outline: Login Screen for Recruiters
    ...
    And the user clicks the Login button
    Then the system processes the login request
    And the user clicks on the profile settings option on the dashboard
    Then the profile settings page is displayed correctly
    And the user's information is displayed accurately
  ...
  Scenario Outline: Login Screen for Recruiters
    ...
    Examples:
      ...
      | krishna@gmail.com    | ValidPassword123   |
  Scenario Outline: Login Screen for Recruiters
    When the recruiter enters "<emailId>" in the Email ID field
    And the recruiter enters "<password>" in the Password field
    And the recruiter clicks the Login button
    Then the system processes the login request
    And the recruiter clicks on the notifications icon on the dashboard
  ...
  Scenario Outline: Login Screen for Recruiters
    ...
    And the recruiter clicks the Login button
    Then the system processes the login request
    And the recruiter clicks on the notifications option on the dashboard
    Then the notifications page is displayed correctly
    And the notifications options are relevant and accessible
  ...
  Scenario Outline: Login Screen for Recruiters
    ...
    Then I observe the page response after clicking the Login button
    And I click on the preferences option on the dashboard
    Then I verify the preferences page is displayed
    And I check that the preferences options are relevant and accessible
  ...
  Scenario Outline: Login Screen for Recruiters
    ...
    And the recruiter clicks the Login button
    Then the system processes the login request
    And the recruiter clicks on the roles option on the dashboard
    Then the roles page is displayed correctly
    And the roles options are relevant and accessible
...
Scenario Outline: Login Screen for Recruiters
  ...
  Scenario Outline: Login Screen for Recruiters
    ...
    And the recruiter clicks on the profile option on the dashboard
    Then the profile page is displayed correctly
    And verifies the profile information is relevant and accurate
